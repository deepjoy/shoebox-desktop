...
## [0.2.2](https://github.com/deepjoy/shoebox-desktop/compare/shoebox-desktop-v0.2.1...shoebox-desktop-v0.2.2) - 2026-04-20

### Added

- root key in OS keychain with age-wrapped backup + settings UI ([#16](https://github.com/deepjoy/shoebox-desktop/pull/16))
